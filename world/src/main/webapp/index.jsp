	...
	<script language="javascript" type="text/javascript">
		function srcchange(id) {
			if (id == "hr1") {
				...
				document.getElementById("mainFrame").src = "run/seeNotice.do?pageno=1";
				document.getElementById("dTitle").style.display = "none";
			} else if (id == "hr18") {
				...
				document.getElementById("mainFrame").src = "${pageContext.request.contextPath}/test/queryBranch.do?pageno=1";
				document.getElementById("dTitle").style.display = "none";
			} else if (id == "hr21") {
...
<body>
	<div style="width: 1430px; height: 100%;">
		<div class="" onmousemove="r(22)" onmouseout="r_1(22)">
			<div class="mian_r_bj png" style="display: none;" id="22"
				onmousemove="r(22)" onmouseout="r_1(22)"></div>
		</div>
			...
			<tr>
				<td width="190" valign="top"
					...
					<div class="side" style="position: absolute;">
						<ul id="nav">
							<li class="y_css" id="xx1" onmouseover="show(1)"
								onmouseout="hidden1(1)"><a href="${pageContext.request.contextPath}/hr/handlers/Readhr.do?pageno=1"
							...
							<li class="y_css" id="xx8"><a href="${pageContext.request.contextPath}/test/queryBranch.do?pageno=1"
					...
					<div class="side_02">
						<ul>
							...
							<a href="../zhanshi_web/index.jsp" target="_blank">
				...
				<td width="1215" valign="top">
					...
					<div style="text-align: right; margin-right: 15px; float: right">
						...
						width="1215" id="mainFrame" name="mainFrame" src="index1.html"></iframe>
				</td>
