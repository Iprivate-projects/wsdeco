			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td>
						<table>
							...
							<tr>
								<td>排序：<input type="text" class="input_04"></td>
							</tr>
							<tr>
								<td>显示：<input type="checkbox"></td>
							</tr>
						</table>
					</td>
					<td>
					...
					<td>
						<table>
							<tr>
								<td><img src="..\images\icon_16.png"></td>
							</tr>
							<tr>
								<td>排序：<input type="text" class="input_04"></td>
							</tr>
					...
					<td>
						<table>
							<tr>
								<td><img src="..\images\icon_17.png"></td>
							</tr>
							<tr>
								<td>排序：<input type="text" class="input_04"></td>
							</tr>
					...
					<td>
						<table>
							<tr>
								<td><img src="..\images\icon_25.png"></td>
							</tr>
							<tr>
								<td>排序：<input type="text" class="input_04"></td>
							</tr>
					...
					<td>
						<table>
							<tr>
								<td><img src="..\images\icon_32.png"></td>
							</tr>
							<tr>
								<td>排序：<input type="text" class="input_04"></td>
							</tr>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td><img src="..\images\icon_33.png"></td>
							</tr>
							<tr>
								<td>排序：<input type="text" class="input_04"></td>
							</tr>
					...
					<td>
						<table>
							<tr>
								<td><img src="..\images\icon_24.png" alt=""></td>
							</tr>
							<tr>
								<td>排序：<input type="text" class="input_04"></td>
							</tr>
				...
				<tr>
					...
					<td colspan="6">
						<div align="center">
							<a href="#"><img src="..\images\bnt_03.gif"
								style="margin-right: 10px;" width="80" height="22"></a><a
								onclick="window.history.go(-1)"><img
								src="..\images\bnt_05.gif" alt="" width="80" height="22"></a>
						</div>
					</td>
				</tr>
			</table>
